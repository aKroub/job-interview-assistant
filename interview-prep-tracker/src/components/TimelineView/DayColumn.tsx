import { formatDayHeader, formatFullDate } from '../../utils/calendarUtils.js';
import { InterviewCard } from './InterviewCard.js';
import type { FlattenedInterview, Interview } from '../../types';
 ...
 */
export function DayColumn({ date, interviews, isToday, isCollapsed = false, onDeleteInterview, onEdit, onUpdateInterview, highlightedInterviewId, onHighlightComplete }: DayColumnProps) {
