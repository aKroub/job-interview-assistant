...
import { TYPE_CONFIG, formatDuration } from '../../constants/interviewTypes.js';
import { deriveInterviewStatus } from '../../utils/companyUtils.js';
...
import type { DerivedInterviewStatus, FlattenedInterview, Interview, InterviewTypeName } from '../../types';
...
interface InterviewCardProps {
  ...
  onDeleteInterview: (companyId: string, interviewId: string) => void;
  onEdit: (interview: FlattenedInterview) => void;
  onUpdateInterview: (companyId: string, interviewId: string, updates: Partial<Interview>) => void;
  highlightedInterviewId: string | null;
  onHighlightComplete: () => void;
}

export function InterviewCard({ interview, onDeleteInterview, onEdit, onUpdateInterview, highlightedInterviewId, onHighlightComplete }: InterviewCardProps) {
  const displayStatus = deriveInterviewStatus(interview) as DerivedInterviewStatus;
  ...
  const trimmedVideoLink = sanitizeVideoCallUrl(interview.videoCallUrl ?? '');
  ...
  function handleSaveLink() {
    ...
    onUpdateInterview(interview.companyId, interview.id, { videoCallUrl: safeLink });
