...
import type { InterviewTypeName, InterviewTypeConfig } from '../types';
 ...
 */
export const INTERVIEW_TYPES: InterviewTypeName[] = [
  'Phone Interview',
  'Video Interview',
  'In-Person Interview',
];
 ...
 */
export const TYPE_CONFIG: Record<InterviewTypeName, InterviewTypeConfig> = {
 ...
 */
export const DURATION_OPTIONS: number[] = [15, 30, 45, 60, 90, 120, 480];

/**
 * Formats a duration in minutes into a human-readable label.
 * @param minutes - Duration in minutes
 * @returns Formatted label (e.g. "30 min", "2 hrs", "Full day (8 hrs)")
 */
